...
import { InforceZoneDetailComponent } from './inforce-zone-detail.component';

fdescribe('InforceZoneDetailComponent', () => {
  let component: InforceZoneDetailComponent;
  let fixture: ComponentFixture<InforceZoneDetailComponent>;
  let valveTypes : IZoneValveType[] = [{ Id : 3, ValveName:""}, { Id:1, ValveName:""}]
  let zone : InforceZoneUIModel ={
    ZoneId: 1,
    ZoneName: "2N Zone 1",
    ValveType: 3,
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ InforceZoneDetailComponent ],
      imports: [  MatTableModule,MatDialogModule,MatSelectModule ,MatFormFieldModule,MatInputModule,ReactiveFormsModule,RouterTestingModule,BrowserAnimationsModule ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(InforceZoneDetailComponent);
    component = fixture.componentInstance;
    component.zone = zone;
    component.well = well;
    component.valveTypes = valveTypes;
    component.isFlowmeterTransmitterNone = false;
