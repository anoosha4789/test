...
import { InforceZoneDialogComponent, IZoneDialogData } from './inforce-zone-dialog.component';

fdescribe('InforceZoneDialogComponent', () => {
  let component: InforceZoneDialogComponent;
  let fixture: ComponentFixture<InforceZoneDialogComponent>;
  let zoneDialogData : IZoneDialogData = {
    zoneDetails: {
      ZoneId: 1,
      ZoneName: "2N Zone 1",
      ValveType: 3,
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ InforceZoneDialogComponent ],
      imports: [  MatTableModule,MatDialogModule,MatFormFieldModule,MatInputModule,ReactiveFormsModule,HttpClientTestingModule,MatSelectModule,BrowserAnimationsModule],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(InforceZoneDialogComponent);
    component = fixture.componentInstance;
    component.data = zoneDialogData
