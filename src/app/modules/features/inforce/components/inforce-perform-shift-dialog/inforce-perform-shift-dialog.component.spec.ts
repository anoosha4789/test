...
import { InforcePerformShiftDialogComponent } from './inforce-perform-shift-dialog.component';
...
fdescribe('InforcePerformShiftDialogComponent', () => {
  let component: InforcePerformShiftDialogComponent;
  let fixture: ComponentFixture<InforcePerformShiftDialogComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ InforcePerformShiftDialogComponent,GwMinuteSecondsPipe ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(InforcePerformShiftDialogComponent);
