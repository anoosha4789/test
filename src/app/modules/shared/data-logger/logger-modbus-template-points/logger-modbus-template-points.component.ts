...
import { PublishingChannelFacade } from '@core/facade/publishingChannelFacade.service'; import { CustomDataLoggerDataPointUIModel } from '@core/models/webModels/DataLogger.model';
...
@Component({
  selector: 'gw-logger-modbus-template-points',
  templateUrl: './logger-modbus-template-points.component.html',
  styleUrls: ['./logger-modbus-template-points.component.scss']
})
export class LoggerModbusTemplatePointsComponent extends GatewayPanelBase implements OnInit, AfterViewInit, OnChanges, OnDestroy {

  @Input()
  selectedDataPoints: CustomDataLoggerDataPointUIModel[];
  ...
  @ViewChild("gridLoggerModbusDataPoints", { static: true })
